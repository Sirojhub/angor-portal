...
function seedDatabase() {
  ...
  const users = [
    ...
    { name:'Dilnoza Rahimova', email:'dilnoza@angor.uz', password: hash('REDACTED_OLD_PASSWORD'), role:'manager',  position:'Moliya menejeri',   department:'Moliya',         phone:'+998 90 222-33-44', avatar:'DR', avatar_color:'#7c3aed', hire_date:'2022-05-15', efficiency:87, status:'active' },
